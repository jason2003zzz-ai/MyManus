...
4. See results
   If agent uses the sandbox_browser tool, you can see the operations by VNC link. The VNC link will print in the terminal, e.g.:https://6080-sandbox-123456.h7890.daytona.work.
